...
temp\build_test\find-using-config\Release\yaml-cpp-test.exe || exit /b 1
temp\build_test\find-using-config\Debug\yaml-cpp-test.exe || exit /b 1
temp\build_test\find-using-module\Release\yaml-cpp-test.exe || exit /b 1
temp\build_test\find-using-module\Debug\yaml-cpp-test.exe || exit /b 1
