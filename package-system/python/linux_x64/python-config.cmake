...
set(${MY}_PATHS             ${CMAKE_CURRENT_LIST_DIR}/python/lib
                            ${CMAKE_CURRENT_LIST_DIR}/python/lib/python3.14
                            ${CMAKE_CURRENT_LIST_DIR}/python/lib/python3.14/lib-dynload
                            ${CMAKE_CURRENT_LIST_DIR}/python/lib/python3.14/site-packages)
...
if (${PAL_PLATFORM_NAME} STREQUAL "Linux" )
    ...
    set(${MY}_LIBRARY_DEBUG   ${CMAKE_CURRENT_LIST_DIR}/python/lib/libpython3.14.so.1.0)
    set(${MY}_LIBRARY_RELEASE ${CMAKE_CURRENT_LIST_DIR}/python/lib/libpython3.14.so.1.0)
    set(${MY}_INCLUDE_DIR     ${CMAKE_CURRENT_LIST_DIR}/python/include/python3.14)
    # DYLIBS causes things to be copied to the bin folder to satisfy RPATH origin
    set(${MY}_DYLIBS_DEBUG    ${CMAKE_CURRENT_LIST_DIR}/python/lib/libpython3.14.so.1.0)
    set(${MY}_DYLIBS_RELEASE  ${CMAKE_CURRENT_LIST_DIR}/python/lib/libpython3.14.so.1.0)
