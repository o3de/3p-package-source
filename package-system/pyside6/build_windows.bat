...
%TEMP_FOLDER%\python-3.10.13-rev1-windows\python\python.exe setup.py build ^
    ...
    --log-level=verbose ^
    --limited-api=no ^
    --skip-modules=Quick,MultimediaWidgets,Pdf,PdfWidgets,Positioning,Location,NetworkAuth,Nfc,WebEngineQuick,Multimedia,QuickControls2,QuickTest,QuickWidgets,UiToolsPrivate,RemoteObjects
