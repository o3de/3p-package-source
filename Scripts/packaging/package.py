...
PACKAGE_BUILD_LIST_FILE = Path(__file__).parent.parent.parent / f"package_build_list_host_{PACKAGE_BUILD_LIST_PLATFORM_ARCH}.json"
with PACKAGE_BUILD_LIST_FILE.open() as f:
    PACKAGE_BUILD_CONFIG = json.load(f)

REMOTE_CACHE_FILE = Path(__file__).parent.parent.parent / ".remote_cache.json"
